...
func TestSchemaSigningDomainTable(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "witness check-in response owns its domain", schema: SchemaWitnessCheckInResponse, domain: SigningDomainWitnessCheckInResponse},
		{name: "witness check-in time commitment owns its domain", schema: SchemaWitnessCheckInTimeCommitment, domain: SigningDomainWitnessCheckInTimeCommitment},
		...
		{name: "release deploy plan owns its domain", schema: SchemaReleaseDeployPlan, domain: SigningDomainReleaseDeployPlan},
...
func TestSigningDomainJSONHostileTable(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "witness check-in response domain round trips", domain: SigningDomainWitnessCheckInResponse, token: SigningDomainTokenWitnessCheckInResponse},
		{name: "witness check-in time commitment domain round trips", domain: SigningDomainWitnessCheckInTimeCommitment, token: SigningDomainTokenWitnessCheckInTimeCommitment},
		...
		{name: "release deploy plan domain round trips", domain: SigningDomainReleaseDeployPlan, token: SigningDomainTokenReleaseDeployPlan},
...
func TestParseSigningDomainHostileTable(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "witness check-in response token accepted", token: SigningDomainTokenWitnessCheckInResponse, want: SigningDomainWitnessCheckInResponse},
		{name: "witness check-in time commitment token accepted", token: SigningDomainTokenWitnessCheckInTimeCommitment, want: SigningDomainWitnessCheckInTimeCommitment},
		...
		{name: "release deploy plan token accepted", token: SigningDomainTokenReleaseDeployPlan, want: SigningDomainReleaseDeployPlan},
