...
func TestPackageImportPathOGSBoundaryTable(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "recursive root pattern", value: "...", wantErr: true},
		{name: "recursive module pattern", value: "example.com/...", wantErr: true},
		{name: "recursive embedded segment", value: "example.com/pkg...suffix", wantErr: true},
		{name: "all meta package", value: GoMetaPackageAll, wantErr: true},
		{name: "standard library meta package", value: GoMetaPackageStandardLibrary, wantErr: true},
		{name: "commands meta package", value: GoMetaPackageCommands, wantErr: true},
		{name: "tools meta package", value: GoMetaPackageTools, wantErr: true},
