...
func BugDeployEndpointsForBaseURL(baseURL string) (DeployEndpoints, error) {
	return deployEndpointsForBaseURL(baseURL, OffgridBugDeployRootPath, core.ProductBug)
}

func WitnessDeployEndpointsForBaseURL(baseURL string) (DeployEndpoints, error) {
	return deployEndpointsForBaseURL(baseURL, OffgridWitnessDeployRootPath, core.ProductWitness)
}

func deployEndpointsForBaseURL(baseURL, rootPath string, product core.Product) (DeployEndpoints, error) {
	...
	endpoints := DeployEndpoints{Prepare: prepare, Finalize: finalize, StatusRoot: statusRoot, Product: product}
